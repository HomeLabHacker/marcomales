...
3. **Zustandsbehaftete Filterung:** Antworten auf erlaubte Verbindungen werden über den Verbindungszustand zugelassen. Eine pauschale Gegenrichtungsfreigabe ist nicht vorgesehen. [Q02]
...
5. **Verwaltung schützen:** Die Weboberfläche ist ausschließlich von ADM01 über HTTPS erreichbar. Automatische Anti-Lockout-Regeln dürfen diese Vorgabe nicht unbemerkt erweitern. Sie werden erst nach Einrichtung und Prüfung des vorgesehenen Zugangs angepasst; die Konsole bleibt verfügbar. [Q02]
...
Die folgenden Freigaben gelten ausschließlich für **CL01 und ADM01 → DC01 (10.10.20.10)**. Unterstützt werden Anmeldung, DNS, Gruppenrichtlinien, SYSVOL/NETLOGON, Zeitversorgung und Domänenbeitritt. Grundlage der Portplanung ist Microsofts Dokumentation; die erforderlichen Funktionen werden zusätzlich im Labor geprüft. [Q01]
...
Auf CL01 wird in Microsoft Edge die verbindliche Richtlinie **DnsOverHttpsMode = off** vorgesehen. Sie deaktiviert Edge-DNS-over-HTTPS. CL01 soll den festgelegten DNS-Weg über DC01 verwenden. Die Richtlinie ist nach Anwendung zu prüfen. Sie ist kein vollständiger Schutz gegen DNS-Tunnel anderer Anwendungen über erlaubtes HTTPS. [Q05]
...
pfSense stellt NTP intern für DC01 bereit; ein öffentlicher NTP-Dienst auf WAN ist nicht vorgesehen. Die tatsächlich ausgewählten Poolserver und der Synchronisationsstatus werden dokumentiert. [Q03]
...
Diese Punkte sind keine stillschweigenden Freigaben für zusätzliche Dienste. Ergebnisse werden in [07 Implementierung](https://claude.ai/chat/07%20Implementierung.md) und [08 Testprotokoll](https://claude.ai/chat/08%20Testprotokoll.md) dokumentiert. Die abschließende Bewertung folgt in [09 Restrisiko](https://claude.ai/chat/09%20Restrisiko.md).
...
|Quelle|Verwendung|
|---|---|
|[02 IST-Analyse – Final](https://claude.ai/chat/02%20IST-Analyse%20-%20Final.md) mit Primärnachweisen|Ausgangsadressen, Topologie, Erreichbarkeit, Benutzer- und Zeitbefunde|
|[03 Schutzbedarf](https://claude.ai/chat/03%20Schutzbedarf.md)|Schutzanforderungen des Bürounternehmensmodells|
|[04 Risikoanalyse](https://claude.ai/chat/04%20Risikoanalyse.md)|R01–R05b, Maßnahmen, Rückfall und Restrisiken|
|[05 Entscheidungsmatrix](https://claude.ai/chat/05%20Entscheidungsmatrix.md)|Auswahl von Variante B und Abgrenzung zu C|
...
|---|---|---|
|Q01|[Microsoft: Firewall für Active Directory und Vertrauensstellungen](https://learn.microsoft.com/en-us/troubleshoot/windows-server/active-directory/config-firewall-for-ad-domains-and-trusts)|Protokoll- und Portgrundlage; szenarioabhängiger Bedarf|
|Q02|[Netgate: Rule Methodology](https://docs.netgate.com/pfsense/en/latest/firewall/rule-methodology.html) und [Firewall Fundamentals](https://docs.netgate.com/pfsense/en/latest/firewall/fundamentals.html)|Zustandsprüfung, Anti-Lockout und private WAN-Netze|
|Q03|[Netgate: NTPD](https://docs.netgate.com/pfsense/en/latest/services/ntpd/index.html) und [General Configuration Options](https://docs.netgate.com/pfsense/en/latest/config/general.html)|NTP-Dienst und vorgesehener Zeitserverpool|
|Q04|[Microsoft: Gruppenrichtlinien für automatische Updates](https://learn.microsoft.com/en-us/windows-server/administration/windows-server-update-services/deploy/4-configure-group-policy-settings-for-automatic-updates)|Automatischer Download mit Benachrichtigung zur Installation|
|Q05|[Microsoft Edge: DnsOverHttpsMode](https://learn.microsoft.com/en-us/deployedge/microsoft-edge-policies/dnsoverhttpsmode)|Verbindlicher Modus off|
|Q06|[Microsoft: Configure IPv6 in Windows](https://learn.microsoft.com/en-us/troubleshoot/windows-server/networking/configure-ipv6-in-windows)|Funktions- und Supportgrenzen einer IPv6-Deaktivierung|
|Q07|[Netgate: Alias Features and Limitations](https://docs.netgate.com/pfsense/en/latest/firewall/aliases-features.html)|Grenzen von Hostnamen-Aliasen und dynamischen Zieladressen|
